...
public class MemberDAO {
	...
	//		   select userid, name from membertbl where userid='hong111' and password='hong111@'
	...
	//중복 아이디 검사
	// select userid from membertbl where userid='hong123';
